...
export const CUSTOMER_TRANSACTIONS: CustomerTransaction[] = [
  ...
  },
  {
    ...
    recipientBank: "Koris Bank Niger Republic",
    ...
    timeline: [
      { title: "Bilateral Transfer Initiated", description: "Cross-border route Providus ⇄ Koris Bank", timestamp: "04:15:00 PM", status: "COMPLETED" },
      { title: "FX Conversion Locked (0.408)", description: "NGN 250,000 converted to 102,000 CFA", timestamp: "04:15:01 PM", status: "COMPLETED" },
      { title: "Koris Bank Sahel Rail Credited", description: "Settled instantly in Niamey clearing account", timestamp: "04:15:03 PM", status: "COMPLETED" },
    ],
  },
  {
    id: "tx-cust-003",
  ...
  },
  {
    ...
    type: "FX_SWAP",
    title: "Instant FX Swap (USD to NGN)",
    description: "Currency swap into Primary Naira wallet",
    amount: 500,
    fee: 2.5,
    totalAmount: 502.5,
    currency: "USD",
    ...
    timeline: [
      { title: "FX Quote Executed", description: "1 USD = ₦1,540.00", timestamp: "03:30:00 PM", status: "COMPLETED" },
      { title: "USD Balance Debited", description: "$500 deducted from USD Vault", timestamp: "03:30:01 PM", status: "COMPLETED" },
      { title: "NGN Balance Credited", description: "₦770,000 added to Naira Wallet", timestamp: "03:30:02 PM", status: "COMPLETED" },
    ],
  },
];
...
export const BANK_DIRECTORY: BankDirectoryEntry[] = [
  ...
  { code: "NE020", name: "Koris Bank Niger Republic", country: "NE", currency: "XOF" },
...
export const FX_RATES: FXRateQuote[] = [
  {
    ...
    source: "KoriePay Bilateral Sahel Engine (Providus ⇄ Koris)",
  },
  {
    fromCurrency: "XOF",
    toCurrency: "NGN",
...
export const CUSTOMER_SUPPORT_TICKETS: SupportTicket[] = [
  {
    ...
    status: "RESOLVED",
    priority: "MEDIUM",
    description: "Wanted to know if transfers initiated after 6 PM settle same day via Koris Bank Sahel node.",
    ...
    messages: [
      {
        ...
        sender: "CUSTOMER",
        senderName: "Ibrahim Dan-Batta",
        message: "Hello team, what is the cut-off time for bilateral cross-border settlements to Maradi Koris Bank accounts?",
        timestamp: "05:30 PM",
      },
      {
        id: "msg-2",
        ...
        message: "Hello Ibrahim, our bilateral clearing with Koris Bank operates 24/7 in real-time with sub-second settlement. Transfers initiated at any hour credit the recipient instantly.",
        timestamp: "06:40 PM",
      },
    ],
  },
