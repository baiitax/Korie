...
export async function POST(req: NextRequest) {
  try {
    ...
    engine.completeDecision(body.decisionId, body.outcome || 'SUCCESS', body.actor || 'System Administrator');
    return NextResponse.json(gateway.createResponse({ completed: true }));
  } catch (err: unknown) {
