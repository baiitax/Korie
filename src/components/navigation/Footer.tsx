...
export const Footer: React.FC = () => {
  ...
  return (
    <footer className="relative bg-[#050914] text-slate-300 border-t border-white/10 overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-16 pb-12">
        ...
        <div className="p-6 sm:p-8 rounded-2xl bg-[#0b1222]/90 border border-white/10 mb-14 shadow-xl flex flex-col lg:flex-row items-center justify-between gap-6">
          <div className="max-w-xl">
            <div className="flex items-center gap-2 mb-2">
              ...
              <span className="text-xs text-slate-400">Nigeria ↔ Niger Republic</span>
            </div>
              ...
              <div className="flex flex-col sm:flex-row gap-2">
                <div className="relative flex-1">
                  ...
                  <input
                    ...
                    className="w-full pl-10 pr-4 py-2.5 rounded-xl bg-slate-900 border border-white/15 text-xs text-white placeholder-slate-500 focus:outline-none focus:border-emerald-500 transition-colors"
                  />
                </div>
                <button
                  type="submit"
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-8 pb-12 border-b border-white/10">
          ...
          <div className="col-span-2 space-y-4">
            <KorieLogo variant="full" theme="dark" height={36} />
            ...
            {/* Live Uptime Status */}
            <div className="pt-2 inline-flex items-center gap-2 px-3 py-1.5 rounded-xl bg-slate-900 border border-white/10 text-[11px] font-mono text-slate-300">
          ...
          {/* Markets Column */}
          <div className="space-y-3">
            <div className="text-xs font-bold uppercase tracking-wider text-white">Markets</div>
            <ul className="space-y-2 text-xs text-slate-400">
              <li>
              ...
              <li>
                <Link href="/solutions/payments" className="hover:text-white transition-colors">
          ...
          <div className="space-y-3">
            ...
            <ul className="space-y-2 text-xs text-slate-400">
              ...
              <li>
                <Link href="/resources" className="hover:text-slate-200 transition-colors">
                  Documentation
                </Link>
              </li>
            </ul>
        ...
        <div className="py-6 border-b border-white/10 text-[11px] text-slate-400 leading-relaxed space-y-2">
          <p>
            <strong className="text-slate-300">Regulatory & Institutional Notice:</strong> KoriePay is a financial technology infrastructure provider operating in partnership with licensed commercial banks, mobile money operators, and authorized Bureau De Change networks across the Federal Republic of Nigeria and the Republic of Niger. KoriePay technology facilitates transaction routing, terminal management, digital wallets, and automated settlements in strict compliance with applicable central banking frameworks and data privacy standards (NDPR / WAEMU).
          </p>
          <p className="text-slate-400">
            Hausa: <span className="text-slate-300 italic">&ldquo;Kudinka, Hannunka&rdquo;</span> — Your Money, in Your Hands. Built for inclusive cross-border African commerce.
          </p>
        </div>
